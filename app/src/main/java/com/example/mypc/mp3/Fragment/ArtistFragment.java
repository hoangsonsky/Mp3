...
import com.example.mypc.mp3.Adapter.ArtistAdapter;
...
public class ArtistFragment extends Fragment {
    ...
    OnClickMS onClickMS = new OnClickMS() {
        ...
        public void onClick123(boolean test, int position) {
            ...
            if (test) {
                ...
                ArrayList<EntitySong> arrayList = infoSong.getData(1, name);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        InfoSong infoSong = new InfoSong(getActivity());
        infoSong.dataArtistFragment(mArrayList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerArtist);
        adapter = new ArtistAdapter(mArrayList, getActivity(), onClickMS);
