...
public class Song123Fragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        OnlineSongFragment songFragment = new OnlineSongFragment();
        Bundle bundle = new Bundle();
        bundle.putString(TEXT_SEARCH, str);
        songFragment.setArguments(bundle);
        transaction.replace(R.id.rlt, songFragment);
