 ...
 */
public class AlbumAdapter extends RecyclerView.Adapter<MyViewHoder> {
    ArrayList<EntitySong> arrayList = new ArrayList<>();
    Activity mContext;
    OnClickMS onClickMS;


    public AlbumAdapter(ArrayList<EntitySong> arrayList, Activity mContext,
                        OnClickMS onClickMS) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int positionItem, long id) {
                ...
                switch (positionItem) {
                    ...
                    case 2:
                        ...
                        addData.listName(position, arrayList.get(position),6);;
                        break;
